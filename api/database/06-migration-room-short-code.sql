-- Migration: add short_code to room table
-- Run once against an existing database:
--   docker exec -i <db-container> psql -U jitsi -d jitsi < 06-migration-room-short-code.sql
...
UPDATE metadata SET mvalue = '20260323.02' WHERE mkey = 'database_version';
